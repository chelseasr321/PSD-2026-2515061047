...
Penjelasan Output:
Program diawali dengan menampilkan isi Hash Table yang berisi data mahasiswa Andi, Budi, Citra, dan Dina. Pada output terlihat bahwa Andi, Budi, dan Citra berada pada kotak penyimpanan yang sama karena memiliki hasil hash yang sama, sehingga disimpan menggunakan metode Separate Chaining dalam bentuk linked list. Sementara itu, Dina berada pada kotak penyimpanan yang berbeda.
